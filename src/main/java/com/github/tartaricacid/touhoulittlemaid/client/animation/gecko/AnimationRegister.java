...
public class AnimationRegister {
    ...
    public static void setParserValue(AnimationEvent<GeckoMaidEntity> animationEvent, MolangParser parser, EntityModelData data, EntityMaid maid) {
        ...
        parser.setValue("query.is_jumping", () -> MolangUtils.booleanToFloat(!maid.isPassenger() && !maid.onGround() && !maid.isInWater()));
        parser.setValue("query.is_on_fire", () -> MolangUtils.booleanToFloat(maid.isOnFire()));
        parser.setValue("query.is_on_ground", () -> MolangUtils.booleanToFloat(maid.onGround()));
        ...
        parser.setValue("query.is_sneaking", () -> MolangUtils.booleanToFloat(maid.onGround() && maid.getPose() == Pose.CROUCHING));
        ...
        parser.setValue("ysm.is_sneak", () -> MolangUtils.booleanToFloat(maid.onGround() && maid.getPose() == Pose.CROUCHING));
